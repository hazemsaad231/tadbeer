...
const responses = {
    ...
    'لماذا نختار تدبير؟': 'نحن نتميز بـ: 1. الخبرة العميقة (30 عاماً). 2. الشفافية والموثوقية. 3. الحلول المتكاملة التي تغطي المالية والإدارة. نحن شركاء النجاح الفعليين لعملائنا.',
    ...
    'شركة داره': '🚗 شركة داره هي شركتك المتخصصة في توريد وتوزيع قطع غيار السيارات الأصلية والموثوقة. تتميز بضمان الجودة والالتزام بالمعايير العالمية. لطلب الملف الاستثماري، يرجى كتابة "استثمار الآن في داره".',
    ...
    'دراسات الجدوي': 'دراسات الجدوى هي خريطتك للنجاح 🗺️. نقدم دراسات تسويقية، فنية، ومالية متكاملة، لمساعدتك في اتخاذ قرارات الاستثمار الصحيحة وضمان ربحية مشاريعك.', // مفتاح إضافي لمعالجة الأخطاء الإملائية
    ...
    'وظائف شاغرة': 'للاطلاع على أحدث الوظائف الشاغرة لدينا، يرجى زيارة قسم "التوظيف" على موقعنا الرسمي أو إرسال سيرتك الذاتية إلى info@tadbeer.sa وسنقوم بإخطارك.',
    ...
    'الموقع الإلكتروني': 'رابط موقعنا الرسمي: https://tadbeer-nine.vercel.app - ستجد فيه تفاصيل خدماتنا والمدونة.',
    ...
    // ---------------------------------------------------------------------
    'أسئلة شائعة': 'مرحباً، إليك قائمة سريعة بأكثر المواضيع شيوعًا حول شركة تدبير:\n\n• من نحن (تعريف بالشركة وخبرتها).\n• الفرص الاستثمارية (للاستثمار في تدبير أو داره).\n• خدمات الشركة (لخدمات الجدوى والمحاسبة).\n• تواصل معنا (لأرقام الهواتف والبريد).\n\nمن فضلك، اكتب السؤال المحدد أو اختر من القائمة السريعة.',
    'المدونة': 'نقدم محتوى قيّم يغطي مواضيع مالية واستشارية متنوعة. بعض الأمثلة تشمل: تحليل الأداء المالي، تأثيرات التضخم، ودراسات الجدوى للمشاريع. يمكنك زيارة قسم المدونة على موقعنا للاطلاع على جميع المقالات.',
