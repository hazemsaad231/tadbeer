  ...
  return (
    <div className="font-['Cairo',sans-serif]" dir="rtl">
              ...
              {isVisible && !isOpen && (
                ...
                >
                    ...
                    <div 
                        ...
                        // تنسيق مخصص للحدود البارزة والظل البنفسجي
                        style={{ 
                            borderColor: '#5C33F6', 
                    ...
                    >
                        <p className="text-sm text-center font-medium text-gray-800 leading-relaxed">
                            ...
                            {/* إضافة نص إضافي ليتناسب مع هيكل الإشعار في الصورة */}
                            <br />
      ...
      {!isOpen && (
        ...
        >
          <MessagesSquare size={28} className="group-hover:rotate-12 transition-transform" />
      ...
      {/* Chatbot Window */}
      {isOpen && (
        <div className="fixed bottom-6 left-3  w-full md:w-[400px] h-[600px] bg-white rounded-2xl shadow-2xl flex flex-col z-50 overflow-hidden border border-gray-200">
