...
//   // لاقي الـ item الحالي بالـ id من البارام
//   const item = items.find((i) => String(i.id) === String(params.id));

//   // مجموع الخدمات (اللي type === 'services')
//   const services = items.filter((it) => it.type === "blogs");

//   // لو الـ item مش لاقي حاجة، رجع رسالة مناسبة
//   if (!item) {
//     return (
//       <div className="p-8">
