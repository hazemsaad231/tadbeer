    ...
    <div className="flex flex-col bg-white">
      ...
      <div className="py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 place-content-center place-items-center p-6 md:p-12 gap-6">
          {data.map((item) => (
            <article key={item.id} className="cursor-pointer w-full flex flex-col gap-2 rounded-xl opacity-90  shadow-md hover:opacity-100 hover:shadow-lg transition-all duration-700 ease-in-out">
