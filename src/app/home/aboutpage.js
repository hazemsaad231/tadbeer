...
const AboutContent = () => {
    return (
        <div className="flex justify-center items-center h-screen bg-white p-8">
        <div className="flex justify-around items-center gap-4">
            <div className="w-1/2 flex flex-col gap-6">
                <h1 className="text-4xl font-bold text-[#262163]">من نحن؟</h1>
                <p className="text-gray-600 text-xl">منشأة احترافية تهدف الى تطوير الاستثمارات والأعمال التجارية والقطاع الخيري، بتقديم استشارات وخدمات مالية وإدارية، بمعايير عالمية، وتقنيات متقدمة ، ملتزمة بقيمها الأصيلة.</p>
                <div className="flex">
