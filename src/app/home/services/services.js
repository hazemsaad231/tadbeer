    ...
    return (
        <div  className="flex flex-col w-screen py-8  bg-[#DFC96D] text-white">
            <div  className="flex flex-col gap-4 text-center py-20 w-full">
                <div className="flex flex-col lg:flex-row justify-center items-center gap-4 w-[70%] m-auto py-8">
                <h1 className="text-2xl sm:text-3xl md:text-4xl xl:text-5xl font-extrabold text-[#262163]">خدمات تدبير المتخصصة</h1>
                <p className="text-md sm:text-md md:text-md lg:text-lg xl:text-lg text-gray-600 w-full">
