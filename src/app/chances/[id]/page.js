...
>
  استثمار الآن
    ...
    <div className="flex justify-between mt-20">
        <h4 className="text-2xl text-[#262163] font-medium">نوع الاستثمار</h4>
        <h1 className="text-2xl text-[#262163] font-extrabold">{item.type}</h1>
    </div>
    <div className="w-full h-[1px] bg-gray-300 my-4"></div>
     <div className="flex justify-between mt-8 mb-4">
        <h4 className="text-2xl text-[#262163] font-medium">مبلغ الاستثمار</h4>
        <h1 className="text-2xl text-[#262163] font-extrabold">{item.price} ر.س</h1>
    </div>
      <div className="w-full h-[1px] bg-gray-300 my-4"></div>
